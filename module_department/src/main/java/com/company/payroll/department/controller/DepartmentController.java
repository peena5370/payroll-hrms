...
import com.company.payroll.department.dto.Department;
import com.company.payroll.department.dto.DepartmentInfo;
...
public class DepartmentController {
    ...
    public ResponseEntity<CommonResponse> getDepartmentInfoById(@PathVariable("id") String departmentId) {
        ...
        Optional<DepartmentInfo> departmentInfo = departmentService.getDepartmentInfoByDepartmentId(Long.parseLong(departmentId));
    ...
    @PostMapping
    public ResponseEntity<CommonResponse> createDepartment(@RequestBody Department departmentDTO) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Object> updateDepartmentInfoById(@PathVariable("id") String departmentId, @RequestBody Department departmentDTO) {
