...
import com.company.payroll.controller.api.BankingController;
import com.company.payroll.service.BankingService;

@WebMvcTest(value=BankingController.class, 
			excludeAutoConfiguration= {SecurityAutoConfiguration.class},
			excludeFilters=@ComponentScan.Filter(type=FilterType.REGEX, pattern="com.company.payroll.*.*Filter"))
public class BankingControllerTest extends AbstractControllerTest {
