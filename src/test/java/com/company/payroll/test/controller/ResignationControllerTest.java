...
import com.company.payroll.controller.api.ResignationController;
import com.company.payroll.service.ResignationService;

@WebMvcTest(value=ResignationController.class, 
			excludeAutoConfiguration= {SecurityAutoConfiguration.class},
			excludeFilters=@ComponentScan.Filter(type=FilterType.REGEX, pattern="com.company.payroll.*.*Filter"))
public class ResignationControllerTest extends AbstractControllerTest {
